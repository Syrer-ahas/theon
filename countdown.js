(function() {
    ...
    style.textContent = `
        ...
        .cdo-particle:nth-child(1) { left: 10%; animation-delay: 0s; }
        ...
        .cdo-particle:nth-child(4) { left: 50%; animation-delay: 0.6s; width: 4px; height: 4px; }
        .cdo-particle:nth-child(5) { left: 65%; animation-delay: 1.8s; }
        .cdo-particle:nth-child(6) { left: 75%; animation-delay: 3.0s; width: 2px; height: 2px; }
        .cdo-particle:nth-child(7) { left: 85%; animation-delay: 0.3s; }
        ...
        @keyframes cdoSepPulse {
            0%,100% { opacity: 0.3; }
            50% { opacity: 0.7; }
        }

        .cdo-flip {
            animation: cdoFlipIn 0.4s cubic-bezier(0.34,1.56,0.64,1) forwards;
        }
        @keyframes cdoFlipIn {
    ...
    overlay.innerHTML = `
        ...
        <div class="cdo-orbs">
            <div class="cdo-orb"></div>
            <div class="cdo-orb"></div>
            <div class="cdo-orb"></div>
        </div>
        <div class="cdo-scan"></div>
        <div class="cdo-particles">
            <div class="cdo-particle"></div>
            <div class="cdo-particle"></div>
            <div class="cdo-particle"></div>
            <div class="cdo-particle"></div>
            <div class="cdo-particle"></div>
        ...
        <div class="cdo-container">
            ...
            <div class="cdo-timer">
                <div class="cdo-unit">
                    <div class="cdo-tile"><span class="cdo-number" id="cdo-days">00</span></div>
                    <span class="cdo-label">Days</span>
                </div>
                <span class="cdo-sep">:</span>
                <div class="cdo-unit">
                    <div class="cdo-tile"><span class="cdo-number" id="cdo-hours">00</span></div>
                    <span class="cdo-label">Hours</span>
                </div>
                <span class="cdo-sep">:</span>
                <div class="cdo-unit">
                    <div class="cdo-tile"><span class="cdo-number" id="cdo-minutes">00</span></div>
                    <span class="cdo-label">Minutes</span>
                </div>
                <span class="cdo-sep">:</span>
                <div class="cdo-unit">
                    <div class="cdo-tile"><span class="cdo-number" id="cdo-seconds">00</span></div>
                    <span class="cdo-label">Seconds</span>
                </div>
            </div>
            <div class="cdo-progress-wrap">
                <div class="cdo-progress-bar">
                    <div class="cdo-progress-fill" id="cdo-progressFill"></div>
                </div>
                <div class="cdo-progress-label">
                    <span>Preparing launch</span>
                    <span id="cdo-progressPct">0%</span>
                </div>
            </div>
            <div class="cdo-bottom">
                <p>🚀 &nbsp; Get ready &nbsp; · &nbsp; <span class="cdo-highlight">#HYPED</span> &nbsp; · &nbsp; Stay tuned</p>
            </div>
        </div>
    `;
    ...
    function tick() {
        ...
        if (prev.days !== -1) {
            if (d !== prev.days)   daysEl.classList.remove('cdo-flip');
            if (h !== prev.hours)  hoursEl.classList.remove('cdo-flip');
            if (m !== prev.minutes) minutesEl.classList.remove('cdo-flip');
            if (s !== prev.seconds) secondsEl.classList.remove('cdo-flip');
            void daysEl.offsetWidth;
            if (d !== prev.days)   daysEl.classList.add('cdo-flip');
            if (h !== prev.hours)  hoursEl.classList.add('cdo-flip');
            if (m !== prev.minutes) minutesEl.classList.add('cdo-flip');
            if (s !== prev.seconds) secondsEl.classList.add('cdo-flip');
        }
